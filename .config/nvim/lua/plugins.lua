...
return require('packer').startup(function(use)
	...
	use {
		...
		ft = { 'cpp', 'c', 'rust', 'sh', 'tex', 'python', 'lua', 'html', 'css', 'json', 'java', 'dart' },
		...
		config = function()
			...
			local servers = { 'ccls', 'texlab', 'rust_analyzer', 'pyright', 'jdtls', 'sumneko_lua' }
	...
	use {
		...
		requires = {'nvim-lua/popup.nvim', 'plenary.nvim', 'tjdevries/astronauta.nvim'},
		after = {'nvim-lspconfig'},
		config = function()
			...
			--vim.lsp.handlers['textDocument/typeDefinition'] = require('lspactions').typeDefinition
			--vim.lsp.handlers['textDocument/implementation'] = require('lspactions').implementation
			--vim.lsp.handlers['textDocument/documentSymbol'] = require('lspactions').document
			--vim.lsp.handlers['workspace/symbol'] = require('lspactions').workspace
		end
	}
